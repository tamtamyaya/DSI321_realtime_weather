...
* ตัวแปรนี้มีผลชัดเจนที่สุด หมายความว่า เมื่อค่า PM10 เพิ่มขึ้น จะทำให้ PM2.5 เพิ่มขึ้นอย่างมาก (ซึ่งสอดคล้องกับธรรมชาติของมลพิษ — PM10 มักสัมพันธ์กับ PM2.5)

2. main.temp (+0.129)
* อุณหภูมิสูงขึ้นมีแนวโน้มจะทำให้ค่า PM2.5 เพิ่มขึ้น อาจเกิดจากอากาศร้อนทำให้การฟุ้งกระจายของฝุ่นลดลง
* ค่า Coefficient เป็นบวก (+0.13) : เมื่ออุณหภูมิเพิ่มขึ้น 1 องศาเซลเซียส จะทำให้ค่าฝุ่น PM2.5 เพิ่มขึ้นเฉลี่ย 0.13 µg/m³

3. main.pressure (+0.114)
* ความกดอากาศสูงอาจกดให้ฝุ่นอยู่ใกล้ผิวโลกมากขึ้น : เมื่อความกดอากาศเพิ่มขึ้น 1 หน่วย (hPa หรือ hectopascal)
* ค่าฝุ่น PM2.5 เพิ่มขึ้นเฉลี่ย 0.11 µg/m³

**ตัวแปรที่มีผล ลดค่า PM2.5**

**main.humidity (ความชื้นสัมพัทธ์):** มีผลต่อค่า PM2.5 โดยมี ค่าสัมประสิทธิ์ (coefficient) เท่ากับ -0.005107

* เมื่อความชื้นสัมพัทธ์เพิ่มขึ้น 1% จะส่งผลให้ค่าฝุ่น PM2.5 มีแนวโน้มจะ ลดลงประมาณ 0.0051 µg/m³ (โดยที่ตัวแปรอื่นคงที่)
